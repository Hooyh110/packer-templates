locals {
  ...
  iso_url       = "http://luna.galaxy.ksyun.com/images/baremetal/2.4/compute/CentOS-7.3-compute-latest.qcow2"
  os_version    = 7.3
...
build {
  ...
  provisioner "shell" {
    scripts = [
      "scripts/install.d/55-firstnode-service-hyh.bash",
    ]
