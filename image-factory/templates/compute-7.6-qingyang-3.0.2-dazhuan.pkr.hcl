locals {
  ...
  anwserfile    = "anwserfiles/ks_centos_7.6_qingyang.cfg"
  iso_checksum  = "file:http://10.91.128.61/images/iso/sha1sum.txt"
  iso_url       = "http://10.91.128.61/images/iso/CentOS-7.6-x86_64-Minimal-1810.iso"
  ...
  img_name      = "${local.os_type}-${local.os_version}-${local.node_type}-qingyang-latest.qcow2"
}
...
#  }
  ...
  provisioner "shell" {
    scripts = [
      ...
      "scripts/install.d/90-raid-drive-hpssacli_sas_7.6.bash",
